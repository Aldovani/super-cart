...
export function ProductsFilter() {
  return (
    <nav className="flex flex-col gap-3 min-w-40">
      <ProductsFilterItem category="">Todos os produtos</ProductsFilterItem>
      <ProductsFilterItem category="promocao">Promoção</ProductsFilterItem>
      <ProductsFilterItem category="basicos">
        Alimentos Básicos
      </ProductsFilterItem>
      <ProductsFilterItem category="congelados">Congelados </ProductsFilterItem>
